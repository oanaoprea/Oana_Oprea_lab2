...
using Oana_Oprea_lab2;
using Oana_Oprea_lab2.Models;
using Microsoft.AspNetCore.Mvc;
using Customer = Oana_Oprea_lab2.Customer;

namespace Nume_Pren_Lab2.Controllers
{
    public class CustomersGrpcController : Controller
    {
        private readonly GrpcChannel channel; public CustomersGrpcController() 
        { 
            channel = GrpcChannel.ForAddress("https://localhost:7024"); 
        }
        [HttpGet]
